...
export default function Modal({ isOpen, onClose, title, children }) {
  ...
  return createPortal(
    <div 
      className="fixed inset-y-0 left-64 right-0 z-50 flex items-center justify-center p-4"
      onClick={handleOverlayClick}
    >
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col transition-all duration-200">
        {/* Header */}
